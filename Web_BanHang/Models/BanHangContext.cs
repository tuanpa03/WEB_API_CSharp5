...
namespace Website_BanHang.Models
{
    public class BanHangContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-V4BEME9\\SQLEXPRESS01;Initial Catalog=Web_MVC_API_Final_CSharp5;Integrated Security=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categroies>().Property(c => c.CatCode)
                .ValueGeneratedOnAdd() //
                .IsRequired();
